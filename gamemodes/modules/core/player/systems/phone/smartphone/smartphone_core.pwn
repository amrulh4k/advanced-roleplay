...
hook OnPlayerClickTextDraw(playerid, Text:clickedid) {
	if(PCoverOpening{playerid}) {
 	    ...
 	    else if(clickedid == TD_PhoneCover[8]) // Purchase
	    {
			...
			else SendClientMessage(playerid, COLOR_WHITE, " Você não tem dinheiro suficiente ($ 500) !");
	    }
	}
...
CreatePhoneTextDraws() {
	...
	TextDrawAlignment(TD_PhoneCover[0], TEXT_DRAW_ALIGN:2);
	...
	TextDrawFont(TD_PhoneCover[0], TEXT_DRAW_FONT_2);
	...
	TextDrawAlignment(TD_PhoneCover[1], TEXT_DRAW_ALIGN:1);
	...
	TextDrawFont(TD_PhoneCover[1], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	TextDrawAlignment(TD_PhoneCover[2], TEXT_DRAW_ALIGN:1);
	...
	TextDrawFont(TD_PhoneCover[2], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	TextDrawAlignment(TD_PhoneCover[3], TEXT_DRAW_ALIGN:1);
	...
	TextDrawFont(TD_PhoneCover[3], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	TextDrawAlignment(TD_PhoneCover[4], TEXT_DRAW_ALIGN:1);
	...
	TextDrawFont(TD_PhoneCover[4], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	TextDrawAlignment(TD_PhoneCover[5], TEXT_DRAW_ALIGN:1);
	...
	TextDrawFont(TD_PhoneCover[5], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	TextDrawAlignment(TD_PhoneCover[6], TEXT_DRAW_ALIGN:1);
	...
	TextDrawFont(TD_PhoneCover[6], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	TextDrawAlignment(TD_PhoneCover[7], TEXT_DRAW_ALIGN:1);
	...
	TextDrawFont(TD_PhoneCover[7], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	TextDrawAlignment(TD_PhoneCover[8], TEXT_DRAW_ALIGN:2);
	...
	TextDrawFont(TD_PhoneCover[8], TEXT_DRAW_FONT_2);
...
CreatePlayerPhoneTextDraws(playerid) {
	...
	PlayerTextDrawAlignment(playerid, TD_PhoneCoverModel[playerid], TEXT_DRAW_ALIGN:1);
	PlayerTextDrawColour(playerid, TD_PhoneCoverModel[playerid], -1);
	PlayerTextDrawSetShadow(playerid, TD_PhoneCoverModel[playerid], false);
	PlayerTextDrawSetOutline(playerid, TD_PhoneCoverModel[playerid], false);
	PlayerTextDrawBackgroundColour(playerid, TD_PhoneCoverModel[playerid], false);
	PlayerTextDrawFont(playerid, TD_PhoneCoverModel[playerid], TEXT_DRAW_FONT_MODEL_PREVIEW);
	PlayerTextDrawSetProportional(playerid, TD_PhoneCoverModel[playerid], false);
	PlayerTextDrawSetShadow(playerid, TD_PhoneCoverModel[playerid], false);
	PlayerTextDrawSetPreviewModel(playerid, TD_PhoneCoverModel[playerid], 18868);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][0], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][0], TEXT_DRAW_FONT_0);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][1], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][1], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][2], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][2], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][3], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][3], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][4], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][4], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][5], TEXT_DRAW_ALIGN:2);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][5], TEXT_DRAW_FONT_1);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][6], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][6], TEXT_DRAW_FONT_0);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][7], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][7], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][8], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][8], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][9], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][9], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][10], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][10], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][11], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][11], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][12], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][12], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Model[playerid][13], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_Model[playerid][13], TEXT_DRAW_FONT_SPRITE_DRAW);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_TFButton[playerid], TEXT_DRAW_ALIGN:1);
	...
	PlayerTextDrawFont(playerid, TDPhone_TFButton[playerid], TEXT_DRAW_FONT_1);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_TSButton[playerid], TEXT_DRAW_ALIGN:3);
	...
	PlayerTextDrawFont(playerid, TDPhone_TSButton[playerid], TEXT_DRAW_FONT_1);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_BigText[playerid], TEXT_DRAW_ALIGN:2);
	...
	PlayerTextDrawFont(playerid, TDPhone_BigText[playerid], TEXT_DRAW_FONT_1);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_ScreenText[playerid], TEXT_DRAW_ALIGN:2);
	PlayerTextDrawColour(playerid, TDPhone_ScreenText[playerid], 488447487);
	...
	PlayerTextDrawFont(playerid, TDPhone_ScreenText[playerid], TEXT_DRAW_FONT_1);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Signal[playerid], TEXT_DRAW_ALIGN:3);
	...
	PlayerTextDrawFont(playerid, TDPhone_Signal[playerid], TEXT_DRAW_FONT_1);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_Picture[playerid], TEXT_DRAW_ALIGN:1);
	PlayerTextDrawColour(playerid, TDPhone_Picture[playerid], -1);
	PlayerTextDrawSetShadow(playerid, TDPhone_Picture[playerid], false);
	PlayerTextDrawSetOutline(playerid, TDPhone_Picture[playerid], false);
	PlayerTextDrawBackgroundColour(playerid, TDPhone_Picture[playerid], 255);
	PlayerTextDrawFont(playerid, TDPhone_Picture[playerid], TEXT_DRAW_FONT_SPRITE_DRAW);
	PlayerTextDrawSetProportional(playerid, TDPhone_Picture[playerid], false);
	PlayerTextDrawSetShadow(playerid, TDPhone_Picture[playerid], false);
	...
	PlayerTextDrawAlignment(playerid, TDPhone_NotifyText[playerid], TEXT_DRAW_ALIGN:3);
	...
	PlayerTextDrawFont(playerid, TDPhone_NotifyText[playerid], TEXT_DRAW_FONT_1);
    ...
    for(new i = 0, Float:y = 352.607360; i < 4; ++i) {
		...
		PlayerTextDrawAlignment(playerid, TDPhone_Choice[playerid][i], TEXT_DRAW_ALIGN:1);
		...
		PlayerTextDrawFont(playerid, TDPhone_Choice[playerid][i], TEXT_DRAW_FONT_1);
...
OnPhoneClick_Selfie(playerid) {
	if(pInfo[playerid][pCallConnect] == INVALID_PLAYER_ID && ph_menuid[playerid] != 6) {
		...
		ApplyAnimation(playerid, "PED", "gang_gunstand", 4.1, false, false, false, true, 0);
